namespace OrderManagement.Modules.UserAccess.Infrastructure.Configuration.Processing.Outbox
{
    internal class ProcessOutboxCommandHandler : ICommandHandler<ProcessOutboxCommand>
    {
        ...
        public async Task Handle(ProcessOutboxCommand command, CancellationToken cancellationToken)
        {
            ...
            Console.WriteLine(schemaExists > 0 ? "ProcessOutboxCommand users exists!" : "ProcessOutboxCommand users NOT found!");
            const string sql = $"""
                               SELECT 
